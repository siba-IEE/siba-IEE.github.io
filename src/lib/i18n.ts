...
export const ui = {
  fr: {
    ...
    'publications.pageLede': 'Articles, logiciels et jeux de données, synchronisés depuis mon profil ORCID.',
  ...
  en: {
    ...
    'publications.pageTitle': 'Publications',
    'publications.pageLede': 'Papers, software and datasets, synced from my ORCID profile.',
